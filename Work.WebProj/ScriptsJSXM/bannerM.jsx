...
var GirdForm = React.createClass({
	...
	getInitialState: function() {  
		return {
			...
			fieldData:{},
			searchData:{title:null,category:1},
			edit_type:0,
			checkAll:false
		};  
	},
	...
	insertType:function(){
		this.setState({edit_type:1,fieldData:{category:1}});
	},
					...
					<form className="form-horizontal" onSubmit={this.handleSubmit}>
						<div className="form-group">
							...
							<div className="col-xs-6">
								<MasterImageUpload 
									FileKind="Photo1" 
									MainId={fieldData.banner_rotator_id}
									ParentEditType={this.state.edit_type}
									url_upload={gb_approot + 'Sys_Active/Banner/aj_FUpload'}
									url_list={gb_approot+'Sys_Active/Banner/aj_FList'}
									url_delete={gb_approot+'Sys_Active/Banner/aj_FDelete'}
									url_sort={gb_approot+'Sys_Active/Banner/aj_FSort'}
									/>
							</div>
							<small className="help-inline col-xs-5 text-danger">須上傳 4 張圖片，否則前台不會顯示</small>
						</div>
						...
						{/*<div className="form-group">
							...
							<small className="col-xs-5 help-inline">請輸入完整 http:// 連結</small>
						</div>*/}
