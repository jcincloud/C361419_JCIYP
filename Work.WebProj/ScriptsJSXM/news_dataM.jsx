						...
						<div className="form-group">
							...
							<div className="col-xs-8">
								<MasterDocFileUpload 
									...
									url_upload={gb_approot + 'Sys_Active/NewsData/aj_FUpload'}
									url_list={gb_approot + 'Sys_Active/NewsData/aj_FList'}
									url_delete={gb_approot + 'Sys_Active/NewsData/aj_FDelete'} 
									url_download={gb_approot + 'Sys_Active/NewsData/aj_FDown'}
									/>
							</div>
						</div>
