							...
							<table>
								<thead>
									<tr>
										...
										<th className="col-xs-2">主行業</th>
										<th className="col-xs-1">行動電話</th>
										<th className="col-xs-1">入會日期</th>
										<th className="col-xs-1">會內職稱</th>
										<th className="col-xs-1">發文註記</th>
										<th className="col-xs-1">會員狀態</th>
			...
			outHtml=(
						<div>
							...
							<div className="alert alert-warning">
								<p>標註 <strong className="text-danger">*</strong> 為必填</p>
							</div>
							<div className="item-box">
								<form className="form-horizontal" onSubmit={this.handleSubmit}>
									...
									<div className="panel-body">
										<div id="profile" className="panel-collapse collapse in">
											...
											<div className="form-group">
												...
												<small className="help-block col-xs-offset-1">第一格為郵遞區號，例: 320 桃園市中壢區明德路280之3號4樓</small>
											</div>
											<div className="form-group">
									...
									<div className="item-title">
										...
										<h5>會員資料 (如需修改以下灰色區塊的資料，請聯繫秘書處)</h5>
									</div>
									<div className="panel-body">
										<div id="info" className="panel-collapse collapse in">
											<div className="form-group">
												...
												<div className="col-xs-3">
													<span className="has-feedback">
														<input id="enter_date" name="入會日期"  value={moment(this.state.fieldData.入會日期).format('YYYY-MM-DD')} disabled/>
													</span>
												</div>
											</div>
											<div className="form-group">
												...
												<div className="col-xs-3">
													<span className="has-feedback">
														<input id="declare_date" name="宣示日期" value={moment(this.state.fieldData.宣示日期).format('YYYY-MM-DD')} disabled/>
													</span>
												</div>
											</div>
											<div className="form-group">
