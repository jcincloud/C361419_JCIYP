var GridRow = React.createClass({
	...
	render:function(){
		return (
				...
				<tr>
					<td className="text-center"><GridButtonView iKey={this.props.ikey} modify={this.modify}/></td>
...
var GirdForm = React.createClass({
	...
	getInitialState: function() {  
		return {
			...
			fieldData:{},
			searchData:{title:null,category:3,year:2014,account:'member'},
			edit_type:0,
			checkAll:false
		};  
	},
				...
				<div>
					...
					<form className="form-horizontal" onSubmit={this.handleSubmit}>
						<div className="form-group">
							...
							<div className="col-xs-11 form-control-static">{fieldData.標題}</div>
						</div>
						<div className="form-group has-feedback">
							<label className="col-xs-1 control-label">日期</label>
							<div className="col-xs-11 form-control-static">{moment(fieldData.活動日期).format('YYYY-MM-DD')}</div>
						</div>
						<div className="form-group">
							<label className="col-xs-1 control-label">附件</label>
							<div className="col-xs-11">
								<MasterDocFileUploadView 
									FileKind="File1" 
						...
						<div className="form-group">
							...
							<div className="col-xs-11 form-control-static">{fieldData.內容}</div>
						</div>

						<div className="form-action">
							<div className="col-xs-4 col-xs-offset-1">
								<button className="col-xs-offset-1" type="button" onClick={this.noneType}><i className="fa-arrow-left"></i> 回前頁</button>
							</div>
						</div>
					</form>
				</div>
