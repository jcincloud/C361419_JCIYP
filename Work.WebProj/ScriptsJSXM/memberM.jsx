	...
	render:function(){
		return (
				...
				<tr>
					...
					<td>{this.props.itemData.主行業}</td>
					<td>{this.props.itemData.行動電話}</td>
					<td>{moment(this.props.itemData.入會日期).format('YYYY-MM-DD')}</td>
					<td>{this.props.itemData.會內職稱}</td>
					<td>{this.props.itemData.發文註記 ? <span className="label label-default">電子檔</span>:<span className="label label-warning">紙本</span>}</td>
					<td>{this.props.itemData.會員狀態 ? <span className="label label-success">正常</span>:<span className="label label-default">休會</span>}</td>
...
var GirdForm = React.createClass({
	...
	insertType:function(){
		...
		if(this.state.edit_type==2){
			this.refs.subGridForm.clearGridData();		
		}
	},
			...
			outHtml=(
						<div>
							...
							<div className="alert alert-warning">
								<p>1.標註 <strong className="text-danger">*</strong> 為必填</p>
							</div>
								...
								<form className="form-horizontal" onSubmit={this.handleSubmit}>
									...
									<div className="panel-body">
										<div id="profile" className="panel-collapse collapse in">
											<div className="form-group">
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>姓名</label>
												...
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>性別</label>
												<div className="col-xs-1">
													<select className="form-control" value={fieldData.SEX} 
													onChange={this.changeFDValue.bind(this,'SEX')}
													required
													>
												...
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>主行業</label>
											...
											<div className="form-group">
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>公司電話</label>
												<div className="col-xs-3">
													<input type="tel" 
													className="form-control"	
												...
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>行動電話</label>
												<div className="col-xs-3">
													<input type="tel" 
													className="form-control"	
											...
											<div className="form-group">
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>Email</label>
												<div className="col-xs-3">
													<input type="email" 
													className="form-control"	
												...
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>生日</label>
												<div className="col-xs-3">
													<span className="has-feedback">
														<InputDateNoRequired id="birthday" name="生日" onChange={this.changeFDValue} value={fieldData.生日} />
											...
											<div className="form-group">
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>地址</label>
												<div className="col-xs-1">
													<input type="text" 
													className="form-control"	
													value={fieldData.區號}
											...
											<div className="form-group">
												<div className="col-xs-12">
													<ul className="nav nav-tabs nav-left" role="tablist">
														...
														<li><a href="#tab3" role="tab" data-toggle="tab"><strong>社團經歷</strong></a></li>
													</ul>
									...
									<div className="panel-body">
										<div id="info" className="panel-collapse collapse in">
											<div className="form-group">
												...
												<div className="col-xs-3">
													<select className="form-control" value={fieldData.會員分類編號} 
													onChange={this.changeFDValue.bind(this,'會員分類編號')}
													required
													>
														<option value="1">見習會友</option>
														<option value="2">一般會友(YB)</option>
												...
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>入會日期</label>
												<div className="col-xs-3">
													<span className="has-feedback">
											...
											<div className="form-group">
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>會員編號</label>
												<div className="col-xs-3">
													<input type="text" 
													className="form-control"	
													value={fieldData.會員編號}
													onChange={this.changeFDValue.bind(this,'會員編號')}
													maxLength="5"
													required />
												</div>
												<label className="col-xs-1 control-label"><small className="text-danger">*</small>登入密碼</label>
												<div className="col-xs-3">
													<input type="text" 
													className="form-control"	
													value={fieldData.密碼}
													onChange={this.changeFDValue.bind(this,'密碼')}
													maxLength="20"
													required />
												</div>
												<label className="col-xs-1 control-label">宣示日期</label>
												<div className="col-xs-3">
													<span className="has-feedback">
														<InputDateNoRequired id="declare_date" name="宣示日期" onChange={this.changeFDValue} value={this.state.fieldData.宣示日期} />
														<i className="fa-calendar form-control-feedback"></i>
													</span>
												</div>
											</div>
											<div className="form-group">
												{/*<label className="col-xs-1 control-label"><small className="text-danger">*</small>排序</label>
												<div className="col-xs-1">
														<input type="number" 
														className="form-control"	
														value={fieldData.排序}
												...
												<small className="help-inline col-xs-1">數字大在前面</small>*/}
												<label className="col-xs-1 control-label">會員狀態</label>
												<div className="col-xs-2">
													<div className="radio-inline">
						                                <label>
															...
															name="is_open_state"
															value={true}
															checked={fieldData.會員狀態===true} 
															onChange={this.changeFDValue.bind(this,'會員狀態')}
															required
																/>
						                                    <span>正常</span>
														</label>
												...
												<label className="col-xs-1 control-label">顯示狀態</label>
												<div className="col-xs-2">
													<div className="radio-inline">
						                                <label>
															<input type="radio" 
												...
												<label className="col-xs-1 control-label">發文註記</label>
												<div className="col-xs-2">
													<div className="radio-inline">
						                                <label>
															<input type="radio" 
															name="is_open"
															value={true}
															checked={fieldData.發文註記===true} 
															onChange={this.changeFDValue.bind(this,'發文註記')}
																/>
						                                    <span>電子檔</span>
														</label>
						                            </div>
									...
									<div className="panel-footer">
                    					<button type="submit" className="btn-primary col-xs-offset-1" name="btn-1"><i className="fa-check"></i> 儲存</button> { }
                    					<button type="submit" className="btn-primary" name="btn-2"><i className="fa-check"></i>儲存，並新增下一筆</button>&nbsp;
...
var SubGirdForm = React.createClass({
	...
	clearGridData:function(){
		var newState = this.state;
		newState.gridData.splice(0,newState.gridData.length);
		this.setState(newState);
		return;
	},
	handleSearch:function(e){
			...
			<div>
				...
				<h4 className="title">
					...
					<button className="btn-link text-success" type="button" onClick={this.creatNewData}>
						<i className="fa-plus-circle"></i> 新增產品
					</button> { }
					<small className="text-danger">每人最多可新增 10 項產品</small>
				</h4>
...
var InputFileUpload = React.createClass({
	...
	render: function() {
		...
		if(this.props.MainId!=0){
			...
			imgHtml=(
				<div className="form-control">
				<small className="col-xs-12 help-inline">請先按儲存後方可上傳圖片</small>
				</div>);
		}
		outHtml=(				
		<div>
