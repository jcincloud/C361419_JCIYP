		...
		if (this.props.ParentEditType==1) {
			...
			creatNewDataHtml=(
				<button className="btn-link text-success" type="button" onClick={this.creatNewData}>
						<i className="fa-plus-circle"></i> 新增活動花絮內容
					</button>
				);
		};
		outHtml=
...
var SubGirdField = React.createClass({
	...
	render: function() {
		...
		outHtml = (
		<div className="panel">
			<div className="panel-heading draggable">
				...
				<div className="panel-body">
					...
					<div className="form-group">
						...
						<div className="col-xs-7">
							<input type="text" 
							className="form-control"	
							value={fieldData.相簿連結}
							onChange={this.changeFDValue.bind(this,'相簿連結')}
							maxLength="255"	/>
						</div>
						<small className="help-inline col-xs-3">請輸入完整連結網址 (包含 http:// 開頭)</small>
					</div>
					<div className="form-group">
