	...
	render:function(){
		...
		React.createElement("div", null, 
			React.createElement("article", null, 
				...
				React.createElement("p", {className: "editor", dangerouslySetInnerHTML: {__html:context}})
			), 
			React.createElement(AppenFile, {main_id: gb_id, file_kind: "file1", url_list: gb_approot + 'Doc/aj_FList'})
		)
			);
