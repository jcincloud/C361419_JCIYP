//後端圖片上傳
var MasterImageUpload = React.createClass({displayName: "MasterImageUpload",
	...
	render: function() {
		...
		if (this.props.ParentEditType==1) {
			...
			imgButtonHtml=(
				...
				React.createElement("input", {type: "file", id: 'upload-btn-' + this.props.MainId, accept: "image/*"})
				)
				);
		};
		outHtml=(				
		React.createElement("div", null, 
			imgButtonHtml, 
			React.createElement("p", {className: "help-block list-group", ref: "SortImage"}, 
			
				this.state.filelist.map(function(itemData,i) {
					var  subOutHtml =
					React.createElement("span", {className: "img-upload list-group-item", key: i}, 
						React.createElement("button", {type: "button", 
						className: "close", 
						onClick: this.deleteFile.bind(this,itemData.FileName), 
						title: "刪除圖片"}, "×"), 
						React.createElement("img", {src: itemData.RepresentFilePath, title: formatFileSize(itemData.Size) })
					);
					return subOutHtml;
				},this)
			
			), 
			React.createElement("div", {id: 'progressBox-' + this.props.MainId, className: "progress-wrap"})
		)
		);
		return outHtml;
	}
