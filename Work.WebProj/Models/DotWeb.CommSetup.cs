    ...
    public static class ImageFileUpParm
    {
        ...
        public static ImageUpScope Product
        {
            get
            {
                ...
                imUp.Parm = new ImageSizeParm[] {
                    new ImageSizeParm(){ SizeFolder=150, width=150}
                };
                return imUp;
            }
        }
        public static ImageUpScope Member
        {
            get
            {
                ImageUpScope imUp = new ImageUpScope() { KeepOriginImage = true, LimitCount = 1, LimitSize = 1024 * 1024 * 2 };
                imUp.Parm = new ImageSizeParm[] {
                    new ImageSizeParm(){ SizeFolder=162, width=162}
                };
                return imUp;
            }
        }
        ...
        public static ImageUpScope BannerRotator
        {
            get
            {
                ImageUpScope imUp = new ImageUpScope() { KeepOriginImage = true, LimitCount = 4, LimitSize = 1024 * 1024 * 2 };
                imUp.Parm = new ImageSizeParm[] {
                    new ImageSizeParm(){FolderName="size1", SizeFolder=800, width=800},
                    new ImageSizeParm(){FolderName="size2", SizeFolder=400, width=400}
                };
                return imUp;
            }
        }
